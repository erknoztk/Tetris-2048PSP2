...
#
#
#  denemelr yapıyoruz githun için oki                                                                           #
################################################################################
      ...
      if stddraw.hasNextKeyTyped():  # check if the user has pressed a key
         ...
         # if the down arrow key has been pressed
            ...
            current_tetromino.rotate(clockwise=True, game_grid=grid)
               ...
               shake_effect(grid, current_tetromino)
...
def create_tetromino():
   ...
   return tetromino
         ...
         # A function for displaying a simple menu before starting the gameü
...
def shake_effect(grid, current_tetromino):
   for i in range(5):
